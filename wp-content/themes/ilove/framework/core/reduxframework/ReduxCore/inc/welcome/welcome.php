<?php
    ...
    class Redux_Welcome {
        ...
        public function change_wp_footer() {
            echo 'If you like <strong>Redux</strong> please leave us a <a href="#" target="_blank" class="redux-rating-link" data-rated="Thanks :)">Rating</a>. A huge thank you from Redux in advance!';
        }
        ...
        public function actions() {
            ...
            <p class="redux-actions">
                ...
                <a href="#" class="twitter-share-button" data-url="#"
