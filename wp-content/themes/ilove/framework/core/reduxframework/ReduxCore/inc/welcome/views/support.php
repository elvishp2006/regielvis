    ...
    <div id="support_div" class="support">
        ...
        <form id="supportform">
            ...
            <fieldset id="final_support">
                ...
                <p><em>
                        <?php
                            echo sprintf( wp_kses( esc_html__( 'Should the developer not be responsive, read the <a href="%s" target="_blank">following article</a> before asking for support from us directly.', 'redux-framework' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( 'http://docs.reduxframework.com/core/support-defined/' ) );
                        ?>
                    </em>
