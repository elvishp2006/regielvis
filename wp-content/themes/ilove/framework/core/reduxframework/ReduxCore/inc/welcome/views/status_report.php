...
<div class="wrap about-wrap redux-status">
        ...
        <tr>
            ...
            <td><?php
                    if ( $sysinfo['redux_data_writeable'] == true ) {
                        ...
                        printf( '<mark class="error">' . '&#10005; ' . esc_html__( 'To allow data saving, make <code>%s</code> writable.', 'redux-framework' ) . '</mark>', $sysinfo['redux_data_dir'] );
                    }
                ?></td>
        </tr>
        <tr>
    ...
    <table class="redux_status_table widefat" cellspacing="0" id="status">
        ...
        <tr>
            ...
            <td><?php
                    echo is_child_theme() ? '<mark class="yes">' . '&#10004;' . '</mark>' : '&#10005; <br /><em>' . sprintf( esc_html__( 'If you\'re modifying Redux Framework or a parent theme you didn\'t build personally, we recommend using a child theme. See: <a href="%s" target="_blank">How to create a child theme</a>', 'redux-framework' ), 'http://codex.wordpress.org/Child_Themes' ) . '</em>';
                ?></td>
        </tr>
        <?php
